        ...
        "list": [
            {
                ...
                "description": "这是专门用来存储LLMOps-Platform LLMOps课程信息的知识库",
                "document_count": 13,
                "icon": "https://imooc-llmops-1257184990.cos.ap-guangzhou.myqcloud.com/2025/04/07/96b5e270-c54a-4424-aece-ff8a2b7e4331.png",
                "id": "c0759ca8-2d35-4480-83a8-1f41f29d1401",
                "name": "LLMOps-Platform LLMOps课程知识库",
...
- **响应示例**：
  ...
  ```json
  {
      ...
      "data": {
          ...
          "name": "LLMOps-Platform LLMOps聊天机器人",
          "icon": "https://imooc-llmops-1257184990.cos.ap-guangzhou.myqcloud.com/2025/04/23/e4422149-4cf7-41b3-ad55-ca8d2caa8f13.png",
          "description": "这是一个LLMOps-Platform LLMOps的Agent应用",
          "status": "published",
...
- **请求示例**：
  ...
  {
  	"name": "LLM应用产品经理",
  	"icon": "https://cdn.imooc.com/2025/05/14/218e5217-ab10-4634-9681-022867955f1b.png",
...
- **响应示例**：
  ...
  ```json
  {
      ...
      "data": {
          ...
          "datasets": [
              {
                  ...
                  "name": "Prompt提示词大全",
                  "icon": "https://imooc-llmops-1304251364.cos.ap-guangzhou.myqcloud.com/2025/10/27/67c94d7b-c503-4528-87c4-1810c17689b1.jpg"
              },
              {
                  "id": "f3f28f75-8e60-4eba-b6df-4d1b390bbd89",
                  "name": "LLMOps-Platform LLMOps项目",
                  "icon": "https://imooc-llmops-1304251364.cos.ap-guangzhou.myqcloud.com/2025/09/29/9f5e42d4-e184-4e2c-88f2-0ef843749e3f.jpg"
              }
          ],
          "retrieval_config": {
          ...
          "review_config": {
              "enable": true,
              "keywords": ["敏感词", "LLMOps-Platform 网"],
              "inputs_config": {
                  "enable": true,
...
- **响应示例**：
  ...
  ```json
  {
      "code": "success",
      "data": {
          "image_url": "https://cdn.imooc.com/2025/05/14/218e5217-ab10-4634-9681-022867955f1b.png"
      },
      "message": ""
  }
  ```
  ...
  ```json
  {
      ...
      "data": {
          "list": [
              {
                  "id": "46db30d1-3199-4e79-a0cd-abf12fa6858f",
                  "name": "LLMOps-Platform LLMOps知识库",
...
- **请求示例**：
  ...
  ```json
  {
      ...
      "description": "Useful for when you want to answer queries about the LLMOps-Platform LLMOps知识库"
  }
  ```
      ...
      "data": [
          {
              ...
              "document": {
                  ...
                  "name": "LLMOps-Platform LLMOps项目API文档.md",
                  "extension": "md",
                  "mime_type": "md"
              },
      ...
      "data": [
          {
              ...
              "query": "LLMOps-Platform LLMOps是什么?",
              "source": "Hit Testing",
      ...
      "data": {
          "documents": [
              ...
              },
              {
                  ...
                  "name": "LLMOps-Platform LLMOps课程提示词.md",
                  "status": "waiting",
...
- **响应示例**：
  ...
  ```json
  {
      ...
      "data": {
          ...
          "name": "泽辉呀",
          "email": "zehuiya@163.com",
          "avatar": "https://cdn.imooc.com/2025/05/14/218e5217-ab10-4634-9681-022867955f1b.png",
...
- **请求示例**：
  ...
  {
      "is_active": true,
      "remark": "LLMOps-Platform 网LLMOps项目API秘钥信息"
  }
  ```
